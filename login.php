...
<head>
  ...
  <title> LOGIN APLIKASI RUMAH SEDERHANA</title>
...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="login-box-body">
      <h4><center><strong>SISTEM INFORMASI PEMESANAN MAKANAN</strong></center></h4>
      <h5><center><strong>Rumah Makan Sederhana</strong></center></h5>
